...
protected:
    void SetUp() override {
        ...
        recover_test_vectors_ = {
            // Test case 1
            {
                "message1",
                "a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3",
                "b25c7db8e9856f1c2b8c5a4e935e5c9f4c8d2f3e7a1b9c6d8e4f1a2b5c7d9e0f",
                "c368923b7f8a9e2d4e6f7a8b9c1d3e5f7a8b9c2d4e6f8a9b1c3d5e7f9a0b2c4d",
                27,
            ...
            {
                "message2",
                "b2e5c7d9f8a7e6d5c4b3a291807f6e5d4c3b2a19f8e7d6c5b4a3928f1e0d9c8b",
                "d472c8e9f1a2b5c7d9e0f3a6b8c1d4e7f9a2b5c8d0e3f6a9b2c5d8e1f4a7b0c3",
                "e5a8d3f6c9b2e4f7a0c3d6e9b2f5a8c1d4e7f0a3b6c9d2e5f8a1c4d7e0a3b6c9",
                28,
            ...
            {
                "message3", 
                "c3f7a9e2d4b6c8e1f3a5d7c9e2f4a6b8d1c3e5f7a9b2c4d6e8f0a3b5c7d9e2f4",
                "f6a9c2e5d8b1f4a7c0d3e6b9c2f5a8b1d4e7f0a3b6c9d2e5f8a1c4d7e0a3b6c9",
                "a7d0c3f6b9e2a5d8c1f4b7e0a3d6c9f2b5a8d1e4f7a0c3b6d9e2f5a8b1c4d7e0",
                27,
        ...
        erc2098_test_vectors_ = {
            {
                ...
                "0xb91467e570a6466aa9e9876cbcd013baba02900b8979d43fe208a4a4f339f5fd6007e74cd82e037b800186422fc2da167c747ef045e5d18a5f5d4300f8e1a0291b"
            }
        };
    }
...
TEST_F(CryptoAllMethodsTest, TestECRecover) {
    ...
    for (const auto& test_vector : recover_test_vectors_) {
        ...
        // Perform EC recovery
        auto recovered_pubkey = Crypto::ECRecover(
            message_hash.GetBytes(),
            r_bytes,
            s_bytes,
            test_vector.recovery
        );
        
        // Verify recovered public key matches expected
        EXPECT_EQ(recovered_pubkey, expected_pubkey)
            << "ECRecover failed for test vector: " << test_vector.message;
    }
...
TEST_F(CryptoAllMethodsTest, TestERC2098) {
    ...
    for (const auto& test_vector : erc2098_test_vectors_) {
        ...
        EXPECT_EQ(compact_signature, expected_compact)
            << "ERC-2098 compact format conversion failed";
        
        // Convert back from compact format
        auto recovered_signature = Crypto::FromERC2098Format(compact_signature);
        
        // Verify round-trip conversion
        EXPECT_EQ(recovered_signature, signature_bytes)
            << "ERC-2098 round-trip conversion failed";
...
TEST_F(CryptoAllMethodsTest, TestPerformance) {
    ...
    std::cout << "Performed " << iterations << " sign+verify operations in " 
