...
protected:
    void SetUp() override {
        ...
        test_elements = {
            io::ByteVector::Parse("1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"),
        ...
        addresses = {
            io::UInt160::Parse("1111111111111111111111111111111111111111"),
...
TEST_F(BloomFilterTest, PatternDataHandling) {
    ...
    std::vector<io::ByteVector> patterns = {
        pattern_sequential, pattern_zeros, pattern_ones, pattern_alternating
    };
...
TEST_F(BloomFilterTest, FalsePositiveRateWithinExpectedRange) {
    ...
    double theoretical_fpr = CalculateTheoreticalFPR(neo_filter->GetBitCount(), 
                                                    neo_filter->GetHashFunctionCount(), 
                                                    num_elements);
