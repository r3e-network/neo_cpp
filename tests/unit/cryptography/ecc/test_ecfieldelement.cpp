...
class ECFieldElementTest : public ::testing::Test
{
  protected:
    void SetUp() override
    {
        ...
        zero_element = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::Zero());

        one_element = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::One());

        two_element = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromInt64(2));

        // Test values matching C# UT_ECFieldElement.cs exactly
        test_value1 = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromHexString(
            "1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"));

        test_value2 = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromHexString(
            "fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321"));

        test_value3 = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromHexString(
            "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));

        // Maximum field element value (field prime - 1)
        max_element = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromHexString(
        ...
        negative_one = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromInt64(-1));

        // Large prime number for testing
        large_prime = std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromHexString(
    ...
    bool IsInFieldRange(const cryptography::ecc::ECFieldElement& element)
    {
        ...
        return value >= cryptography::BigInteger::Zero() && value < cryptography::ecc::ECFieldElement::GetFieldPrime();
    }
...
TEST_F(ECFieldElementTest, SquareRootWorksCorrectly)
{
    ...
    bool is_correct = (sqrt_result == *test_value1) || (sqrt_result == -*test_value1);
    ...
    bool one_sqrt_correct = (one_sqrt == *one_element) || (one_sqrt == *negative_one);
...
TEST_F(ECFieldElementTest, ToByteArrayReturnsCorrectData)
{
    ...
    auto reconstructed_zero =
        std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromByteArray(zero_bytes));
    auto reconstructed_one =
        std::make_shared<cryptography::ecc::ECFieldElement>(cryptography::BigInteger::FromByteArray(one_bytes));
...
TEST_F(ECFieldElementTest, FieldPrimeIsCorrect)
{
    ...
    auto expected_prime =
        cryptography::BigInteger::FromHexString("fffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f");
