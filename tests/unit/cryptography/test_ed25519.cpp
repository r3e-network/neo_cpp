...
class Ed25519Test : public ::testing::Test
{
  protected:
    void SetUp() override
    {
        ...
        long_message = io::ByteVector::Parse("4c6f72656d20697073756d20646f6c6f722073697420616d65742c20636f6e73656374657"
                                             "475722061646970697363696e6720656c6974");  // Lorem ipsum
...
{
    EXPECT_THROW(cryptography::Ed25519::GeneratePublicKey(invalid_private_key), std::invalid_argument);

    EXPECT_THROW(cryptography::Ed25519::Sign(test_message, invalid_private_key), std::invalid_argument);
}

TEST_F(Ed25519Test, InvalidPublicKeySize)
{
    EXPECT_THROW(cryptography::Ed25519::Verify(test_message, signature1, invalid_public_key), std::invalid_argument);
}

TEST_F(Ed25519Test, InvalidSignatureSize)
{
    EXPECT_THROW(cryptography::Ed25519::Verify(test_message, invalid_signature, public_key1), std::invalid_argument);
}
