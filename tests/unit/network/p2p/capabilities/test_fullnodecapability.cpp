...
// Complete FullNodeCapability test methods - production-ready implementation matching C# UT_FullNodeCapability.cs
// exactly
...
TEST_F(FullNodeCapabilityTest, CapabilityInitialization)
{
    ...
    EXPECT_EQ(full_node_capability->GetCapabilityType(),
              network::p2p::capabilities::CapabilityType::FullNodeCapability);
}
