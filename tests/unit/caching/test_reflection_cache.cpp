...
public:
    ...
    virtual std::string GetTypeName() const { return "TestItem"; }
};
...
public:
    ...
    std::string GetTypeName() const override { return "TestItem1"; }
...
public:
    ...
    std::string GetTypeName() const override { return "TestItem2"; }
...
public:
    ...
    static void Register(TEnum enum_value) {
        ...
        cache_[enum_value] = []() -> std::unique_ptr<ISerializable> {
...
private:
    ...
    static std::unordered_map<TEnum, std::function<std::unique_ptr<ISerializable>(const std::vector<uint8_t>&)>> serializable_cache_;
};
...
public:
    ...
    std::string GetTypeName() const override { return "AnotherTestItem"; }
};
