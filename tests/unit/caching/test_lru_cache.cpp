...
TEST_F(LRUCacheTest, MemoryManagement) {
    ...
    struct CountedString {
        ...
        CountedString(const std::string& v) : value(v) { ++instance_count; }
        CountedString(const CountedString& other) : value(other.value) { ++instance_count; }
        ~CountedString() { --instance_count; }
