...
TEST_F(ApplicationEngineTest, AddGas)
{
    ...
    auto engine = std::make_shared<ApplicationEngine>(TriggerType::Application, transaction_.get(), snapshot_, nullptr, 100);
...
TEST_F(ApplicationEngineTest, StorageOperations)
{
    ...
    ByteVector script = ByteVector::Parse(
        "0c0576616c75650c036b6579800000000000000000000000000000000000000000" // PUSHDATA1 "value", PUSHDATA1 "key", SYSCALL (System.Storage.Put)
...
TEST_F(ApplicationEngineTest, Notifications)
{
    ...
    ByteVector script = ByteVector::Parse(
        "0c0576616c75650c036b6579800000000000000000000000000000000000000000" // PUSHDATA1 "value", PUSHDATA1 "key", SYSCALL (System.Runtime.Notify)
    );
