...
#include <memory>
#include <neo/neo/smartcontract/manifest/contractpermission.h>
#include <vector>
...
TEST_F(ContractpermissionTest, Construction)
{
...
TEST_F(ContractpermissionTest, BasicFunctionality)
{
    // Implement basic functionality tests
    SUCCEED() << "Implement specific tests for Contractpermission";
}
