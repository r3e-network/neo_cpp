...
class TrimmedBlockTest : public ::testing::Test
{
  protected:
    void SetUp() override
    {
        ...
        trimmed_block = std::make_shared<ledger::TrimmedBlock>(1,               // version
...
{
    auto same_block = std::make_shared<ledger::TrimmedBlock>(1, previous_hash, merkle_root, 1640995200, 12345, 100, 0,
                                                             next_consensus, tx_hashes);
