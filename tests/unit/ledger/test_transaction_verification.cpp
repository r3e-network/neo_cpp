...
TEST_F(TransactionVerificationTest, WitnessScopeValidation)
{
    ...
    std::vector<WitnessScope> scopes = {WitnessScope::None, WitnessScope::CalledByEntry, WitnessScope::CustomContracts,
...
TEST_F(TransactionVerificationTest, ConcurrentVerification)
{
    ...
    for (int t = 0; t < num_threads; ++t)
    {
        threads.emplace_back(
            [this, transactions_per_thread, &valid_transactions, &invalid_transactions]()
            {
