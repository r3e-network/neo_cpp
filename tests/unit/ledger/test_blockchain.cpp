...
class BlockchainTest : public ::testing::Test
{
  protected:
    void SetUp() override
    {
        ...
        test_block_hashes = {io::UInt256::Parse("4444444444444444444444444444444444444444444444444444444444444444"),
    ...
    std::shared_ptr<ledger::Transaction> CreateGenesisTransaction()
    {
        ...
        output.SetAssetId(
            io::UInt256::Parse("602c79718b16e442de58778e148d0b1084e3b2dffd5de6b7b16cee7969282de7"));  // GAS
    ...
    std::shared_ptr<ledger::Transaction> CreateTestTransaction(int seed)
    {
        ...
        if (!test_keypairs.empty())
        {
            ...
            witness.SetVerificationScript(
                CreateVerificationScript(test_keypairs[seed % test_keypairs.size()]->GetPublicKey()));
    ...
    bool ValidateBlockchainState()
    {
        ...
        if (blockchain->GetHeight() != blockchain->GetHeaderHeight())
            return false;
