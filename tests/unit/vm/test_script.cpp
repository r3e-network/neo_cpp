...
TEST(ScriptTest, GetPrice)
{
    ...
    // Standard operations - Neo N3 prices
    EXPECT_EQ(Script::GetPrice(OpCode::PUSH0), 30);
    EXPECT_EQ(Script::GetPrice(OpCode::PUSH1), 30);
    EXPECT_EQ(Script::GetPrice(OpCode::ADD), 240);

    // Push operations - Neo N3 prices
    EXPECT_EQ(Script::GetPrice(OpCode::PUSHDATA1), 30);
    EXPECT_EQ(Script::GetPrice(OpCode::PUSHDATA2), 30);
    EXPECT_EQ(Script::GetPrice(OpCode::PUSHDATA4), 30);
    EXPECT_EQ(Script::GetPrice(OpCode::PUSH16), 30);
}
