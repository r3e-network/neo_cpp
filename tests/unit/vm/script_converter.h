...
class ScriptConverter
{
  ...
  private:
    ...
    static OpCode ParseOpCode(const std::string& value)
    {
        ...
        if (upperValue == "NOP")
            return OpCode::NOP;
        else if (upperValue == "PUSH0")
            return OpCode::PUSH0;
        else if (upperValue == "PUSHDATA1")
            return OpCode::PUSHDATA1;
        else if (upperValue == "PUSHDATA2")
            return OpCode::PUSHDATA2;
        else if (upperValue == "PUSHDATA4")
            return OpCode::PUSHDATA4;
        else if (upperValue == "PUSHM1")
            return OpCode::PUSHM1;
        else if (upperValue == "PUSH1")
            return OpCode::PUSH1;
        else if (upperValue == "PUSH2")
            return OpCode::PUSH2;
        else if (upperValue == "PUSH3")
            return OpCode::PUSH3;
        else if (upperValue == "PUSH4")
            return OpCode::PUSH4;
        else if (upperValue == "PUSH5")
            return OpCode::PUSH5;
        else if (upperValue == "PUSH6")
            return OpCode::PUSH6;
        else if (upperValue == "PUSH7")
            return OpCode::PUSH7;
        else if (upperValue == "PUSH8")
            return OpCode::PUSH8;
        else if (upperValue == "PUSH9")
            return OpCode::PUSH9;
        else if (upperValue == "PUSH10")
            return OpCode::PUSH10;
        else if (upperValue == "PUSH11")
            return OpCode::PUSH11;
        else if (upperValue == "PUSH12")
            return OpCode::PUSH12;
        else if (upperValue == "PUSH13")
            return OpCode::PUSH13;
        else if (upperValue == "PUSH14")
            return OpCode::PUSH14;
        else if (upperValue == "PUSH15")
