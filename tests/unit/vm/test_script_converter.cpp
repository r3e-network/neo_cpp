...
TEST_F(UT_ScriptConverter, TestConvertJsonToScript)
{
    ...
    std::vector<uint8_t> expected = {static_cast<uint8_t>(OpCode::NOP), static_cast<uint8_t>(OpCode::PUSH1),
                                     static_cast<uint8_t>(OpCode::PUSH2), static_cast<uint8_t>(OpCode::ADD)};
...
TEST_F(UT_ScriptConverter, TestHexStringInJson)
{
    ...
    // Expected script bytes
    std::vector<uint8_t> expected = {static_cast<uint8_t>(OpCode::NOP), 0x01, 0x02, 0x03, 0x04, 0x05};
