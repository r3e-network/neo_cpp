...
#include <neo/neo/extensions/collectionextensions.h>
#include <memory>
#include <vector>
...
TEST_F(CollectionextensionsTest, Construction) {
...
TEST_F(CollectionextensionsTest, BasicFunctionality) {
    // Implement basic functionality tests
    SUCCEED() << "Implement specific tests for Collectionextensions";
}
