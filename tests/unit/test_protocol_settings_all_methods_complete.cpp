...
class ProtocolSettingsAllMethodsTest : public ::testing::Test
{
  protected:
    ...
    ProtocolSettings CreateTestProtocolSettings()
    {
        ...
        // Set up seed list
        std::vector<std::string> seedList = {"seed1.neo.org:10333", "seed2.neo.org:10333", "seed3.neo.org:10333",
                                             "seed4.neo.org:10333", "seed5.neo.org:10333"};
...
{
    std::vector<std::string> expected = {"seed1.neo.org:10333", "seed2.neo.org:10333", "seed3.neo.org:10333",
                                         "seed4.neo.org:10333", "seed5.neo.org:10333"};
...
TEST_F(ProtocolSettingsAllMethodsTest, TestECPointParsing)
{
    for (const auto& point : test_settings_.GetStandbyCommittee())
    {
        EXPECT_NO_THROW({ ECPoint::Parse(point.ToString()); });
    }
}
