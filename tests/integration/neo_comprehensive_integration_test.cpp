...
TEST_F(NeoComprehensiveIntegrationTest, NetworkAddressWithTimeCompatibility)
{
    ...
    // Test IPv4 address
    {
        auto addr = neo::network::p2p::payloads::NetworkAddressWithTime::FromIPv4(
            1640995200, 1, "127.0.0.1", 10333);
...
TEST_F(NeoComprehensiveIntegrationTest, SerializationPerformance)
{
    ...
    std::cout << "Serialization performance: " << iterations 
...
TEST_F(NeoComprehensiveIntegrationTest, ErrorHandlingAndEdgeCases)
{
    ...
    {
        EXPECT_THROW({
            neo::network::p2p::payloads::NetworkAddressWithTime::FromIPv4(
                0, 0, "invalid.address", 10333);
