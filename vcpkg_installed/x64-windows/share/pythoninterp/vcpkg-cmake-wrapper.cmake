...
if(TARGET PYTHON::Python)
    target_compile_definitions(PYTHON::Python INTERFACE "Py_NO_LINK_LIB")
endif()
if(TARGET PYTHON::Module)
    target_compile_definitions(PYTHON::Module INTERFACE "Py_NO_LINK_LIB")
endif()
if(TARGET PYTHON::SABIModule)
    target_compile_definitions(PYTHON::SABIModule INTERFACE "Py_NO_LINK_LIB")
endif()
