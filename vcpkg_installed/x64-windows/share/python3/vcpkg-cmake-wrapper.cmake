...
if(TARGET Python3::Python)
    target_compile_definitions(Python3::Python INTERFACE "Py_NO_LINK_LIB")
endif()
if(TARGET Python3::Module)
    target_compile_definitions(Python3::Module INTERFACE "Py_NO_LINK_LIB")
endif()
if(TARGET Python3::SABIModule)
    target_compile_definitions(Python3::SABIModule INTERFACE "Py_NO_LINK_LIB")
endif()
