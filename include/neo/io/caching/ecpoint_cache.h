...
namespace neo::io::caching
{
    ...
    public:
         ...
         */
        explicit ECPointCache(size_t capacity)
            : cache_(capacity)
        {
        }
         ...
         * @return The ECPoint.
         */
        std::shared_ptr<cryptography::ecc::ECPoint> GetOrCreate(const ByteVector& bytes, std::shared_ptr<cryptography::ecc::ECCurve> curve)
        {
