...
class ReferenceCounter
{
   ...
   private:
     ...
     */
    void StrongConnect(std::shared_ptr<StackItem> v, std::unordered_map<std::shared_ptr<StackItem>, int>& indices,
    ...
    std::unordered_map<std::shared_ptr<StackItem>, std::unordered_map<std::shared_ptr<StackItem>, ReferenceEntry>>
        references_;
    ...
    bool HasCircularReference(std::shared_ptr<StackItem> root,
