...
namespace neo::vm
{
    ...
    public:
         ...
         * @param message The error message.
         */
        explicit BadScriptException(const std::string& message)
            : VMException(message)
        {
        }
    };
    ...
    public:
         ...
         * @param message The error message.
         */
        explicit CatchableException(const std::string& message)
            : VMException(message)
        {
        }
    };
    ...
    public:
         ...
         * @param message The error message.
         */
        explicit DivideByZeroException(const std::string& message = "Division by zero")
            : VMException(message)
        {
        }
    };
