...
namespace neo::vm
{
    ...
    public:
         ...
         * @param other The other stack item.
         * @return A negative value if this item is less than the other, 0 if they are equal, and a positive value if this item is greater than the other.
         */
         ...
         * @return The struct stack item.
         */
        static std::shared_ptr<StackItem> CreateStruct(const std::vector<std::shared_ptr<StackItem>>& items, ReferenceCounter& refCounter);
