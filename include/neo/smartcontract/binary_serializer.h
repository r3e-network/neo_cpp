...
namespace neo::smartcontract
{
    ...
    public:
         ...
         */
        static io::ByteVector Serialize(std::shared_ptr<vm::StackItem> item, int64_t maxSize = 2048, int64_t maxItems = 2048);
         ...
         */
        static std::shared_ptr<vm::StackItem> Deserialize(const io::ByteSpan& data, int64_t maxSize = 2048, int64_t maxItems = 2048);
    ...
    private:
         ...
         */
        static void SerializeStackItem(io::BinaryWriter& writer, std::shared_ptr<vm::StackItem> item, 
         ...
         * @return The deserialized StackItem.
         */
        static std::shared_ptr<vm::StackItem> DeserializeStackItem(io::BinaryReader& reader, 
                                                                 int64_t maxSize, int64_t maxItems, int64_t& itemCount);
    };
}
