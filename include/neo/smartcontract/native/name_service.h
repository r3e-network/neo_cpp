...
class NameService : public NativeContract
{
  ...
  public:
     ...
     */
    std::tuple<io::UInt160, uint64_t> GetName(std::shared_ptr<persistence::DataCache> snapshot,
     ...
     */
    std::string GetRecord(std::shared_ptr<persistence::DataCache> snapshot, const std::string& name,
     ...
     */
    void SetRecord(std::shared_ptr<persistence::DataCache> snapshot, const std::string& name, const std::string& type,
     ...
     * @param type The record type.
     */
    void DeleteRecord(std::shared_ptr<persistence::DataCache> snapshot, const std::string& name,
  ...
  private:
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnIsAvailable(ApplicationEngine& engine,
                                                 const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnRegister(ApplicationEngine& engine,
                                              const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnRenew(ApplicationEngine& engine,
                                           const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnTransfer(ApplicationEngine& engine,
                                              const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnDelete(ApplicationEngine& engine,
                                            const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnResolve(ApplicationEngine& engine,
                                             const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetOwner(ApplicationEngine& engine,
                                              const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetExpiration(ApplicationEngine& engine,
                                                   const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetRecord(ApplicationEngine& engine,
                                               const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnSetRecord(ApplicationEngine& engine,
                                               const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnDeleteRecord(ApplicationEngine& engine,
                                                  const std::vector<std::shared_ptr<vm::StackItem>>& args);
