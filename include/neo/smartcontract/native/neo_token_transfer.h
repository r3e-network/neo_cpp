...
namespace neo::smartcontract::native
{
    ...
    public:
         ...
         * @return The result.
         */
        static std::shared_ptr<vm::StackItem> OnTotalSupply(const NeoToken& token, neo::smartcontract::ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        static std::shared_ptr<vm::StackItem> OnTransfer(const NeoToken& token, neo::smartcontract::ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
    };
}
