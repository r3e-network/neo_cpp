...
class ContractManagement : public NativeContract
{
  ...
  public:
     ...
     * @return The contract.
     */
    std::shared_ptr<ContractState> GetContract(std::shared_ptr<persistence::StoreView> snapshot,
     ...
     */
    bool HasMethod(std::shared_ptr<persistence::StoreView> snapshot, const io::UInt160& hash, const std::string& method,
     ...
     * @return The contract.
     */
    std::shared_ptr<ContractState> CreateContract(std::shared_ptr<persistence::StoreView> snapshot,
                                                  const io::ByteVector& script, const std::string& manifest,
                                                  const io::UInt160& hash) const;
     ...
     * @return The contract.
     */
    std::shared_ptr<ContractState> UpdateContract(std::shared_ptr<persistence::StoreView> snapshot,
  ...
  private:
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetMinimumDeploymentFee(ApplicationEngine& engine,
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnSetMinimumDeploymentFee(ApplicationEngine& engine,
                                                             const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnDeploy(ApplicationEngine& engine,
                                            const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnUpdate(ApplicationEngine& engine,
                                            const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnDestroy(ApplicationEngine& engine,
                                             const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetContract(ApplicationEngine& engine,
                                                 const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnHasMethod(ApplicationEngine& engine,
                                               const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnListContracts(ApplicationEngine& engine,
                                                   const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetContractById(ApplicationEngine& engine,
                                                     const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnGetContractHashes(ApplicationEngine& engine,
                                                       const std::vector<std::shared_ptr<vm::StackItem>>& args);
