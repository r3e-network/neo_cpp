...
namespace neo::smartcontract::native
{
    ...
    protected:
         ...
         * @param data The data.
         */
        void OnNEP17Payment(ApplicationEngine& engine, const io::UInt160& from, int64_t amount, std::shared_ptr<vm::StackItem> data);

        // Method adapters for RegisterMethod calls
        std::shared_ptr<vm::StackItem> OnGetMaxNotValidBeforeDelta(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnSetMaxNotValidBeforeDelta(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnExpirationOf(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnBalanceOf(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnLockDepositUntil(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnWithdraw(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnVerify(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
        std::shared_ptr<vm::StackItem> OnNEP17PaymentAdapter(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The deposit.
         */
        std::shared_ptr<Deposit> GetDepositFor(std::shared_ptr<persistence::StoreView> snapshot, const io::UInt160& account) const;
