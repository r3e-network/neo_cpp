...
namespace neo::smartcontract::native
{
    ...
    private:
        ...
        bool VerifySecp256k1Signature(const io::ByteVector& message, const io::ByteVector& signature, const cryptography::ecc::ECPoint& publicKey);
        bool IsValidSecp256k1PublicKey(const cryptography::ecc::ECPoint& publicKey);
        std::pair<std::optional<io::ByteVector>, std::optional<io::ByteVector>> ParseSecp256k1Signature(const io::ByteVector& signature);
        bool VerifySecp256k1ECDSA(const io::UInt256& messageHash, const io::ByteVector& r, const io::ByteVector& s, const cryptography::ecc::ECPoint& publicKey);
