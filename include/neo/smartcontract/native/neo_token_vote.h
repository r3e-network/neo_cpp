...
class NeoTokenVote
{
   public:
     ...
     */
    static bool Vote(const NeoToken& token, std::shared_ptr<persistence::DataCache> snapshot,
     ...
     * @return The result.
     */
    static std::shared_ptr<vm::StackItem> OnVote(const NeoToken& token, ApplicationEngine& engine,
     ...
     * @return The result.
     */
    static std::shared_ptr<vm::StackItem> OnUnVote(const NeoToken& token, ApplicationEngine& engine,
                                                   const std::vector<std::shared_ptr<vm::StackItem>>& args);
};
}  // namespace neo::smartcontract::native
