...
namespace neo::smartcontract::native
{
    ...
    public:
         ...
         * @return True if the block is traceable, false otherwise.
         */
        bool IsTraceableBlock(std::shared_ptr<persistence::DataCache> snapshot, uint32_t index, uint32_t maxTraceableBlocks) const;
         ...
         * @return The block.
         */
        std::shared_ptr<ledger::Block> GetBlock(std::shared_ptr<persistence::DataCache> snapshot, const io::UInt256& hash) const;
         ...
         */
        std::shared_ptr<ledger::Transaction> GetTransaction(std::shared_ptr<persistence::DataCache> snapshot, const io::UInt256& hash) const;
    ...
    private:
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetHash(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetBlock(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetTransaction(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetTransactionHeight(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetCurrentIndex(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetCurrentHash(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
