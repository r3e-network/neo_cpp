...
class GasToken : public FungibleToken
{
  ...
  public:
     ...
     */
    bool Transfer(std::shared_ptr<persistence::StoreView> snapshot, const io::UInt160& from, const io::UInt160& to,
     ...
     * @return True if the transfer was successful, false otherwise.
     */
    bool Transfer(ApplicationEngine& engine, const io::UInt160& from, const io::UInt160& to, int64_t amount,
                  std::shared_ptr<vm::StackItem> data, bool callOnPayment) override;
     ...
     */
    bool PostTransfer(ApplicationEngine& engine, const io::UInt160& from, const io::UInt160& to, int64_t amount,
                      std::shared_ptr<vm::StackItem> data, bool callOnPayment) override;
  ...
  private:
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnSymbol(ApplicationEngine& engine,
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnDecimals(ApplicationEngine& engine,
                                              const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnTotalSupply(ApplicationEngine& engine,
                                                 const std::vector<std::shared_ptr<vm::StackItem>>& args);
     ...
     * @return The result.
     */
    std::shared_ptr<vm::StackItem> OnNEP17Payment(ApplicationEngine& engine,
                                                  const std::vector<std::shared_ptr<vm::StackItem>>& args);
};
}  // namespace neo::smartcontract::native
