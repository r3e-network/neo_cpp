...
namespace neo::smartcontract::native
{
    ...
    public:
         ...
         * @return The requests.
         */
        std::vector<std::pair<uint64_t, OracleRequest>> GetRequestsByUrl(std::shared_ptr<persistence::StoreView> snapshot, const std::string& url) const;
         ...
         */
        uint64_t CreateRequest(std::shared_ptr<persistence::StoreView> snapshot, const std::string& url, const std::string& filter,
    ...
    private:
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnGetOracles(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnSetOracles(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnRequest(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
         ...
         * @return The result.
         */
        std::shared_ptr<vm::StackItem> OnFinish(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args);
