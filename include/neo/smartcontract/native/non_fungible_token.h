...
namespace neo::smartcontract::native
{
    ...
    public:
         ...
         * @return The owner.
         */
        virtual io::UInt160 GetOwnerOf(std::shared_ptr<persistence::StoreView> snapshot, const io::ByteVector& tokenId) const;
         ...
         */
        virtual std::map<std::string, std::shared_ptr<vm::StackItem>> GetProperties(std::shared_ptr<persistence::StoreView> snapshot, const io::ByteVector& tokenId) const;
         ...
         * @return The tokens.
         */
        virtual std::vector<io::ByteVector> GetTokensOf(std::shared_ptr<persistence::StoreView> snapshot, const io::UInt160& account) const;
         ...
         */
        virtual bool Transfer(std::shared_ptr<persistence::StoreView> snapshot, const io::UInt160& from, const io::UInt160& to, const io::ByteVector& tokenId);
         ...
         * @return True if successful, false otherwise.
         */
        virtual bool Transfer(ApplicationEngine& engine, const io::UInt160& from, const io::UInt160& to, const io::ByteVector& tokenId, std::shared_ptr<vm::StackItem> data, bool callOnPayment);
    ...
    protected:
         ...
         * @return True if successful, false otherwise.
         */
        virtual bool Mint(std::shared_ptr<persistence::StoreView> snapshot, const io::ByteVector& tokenId, const io::UInt160& owner, const std::map<std::string, std::shared_ptr<vm::StackItem>>& properties);
         ...
         * @return True if successful, false otherwise.
         */
        virtual bool Mint(ApplicationEngine& engine, const io::ByteVector& tokenId, const io::UInt160& owner, const std::map<std::string, std::shared_ptr<vm::StackItem>>& properties, std::shared_ptr<vm::StackItem> data, bool callOnPayment);
         ...
         * @return True if successful, false otherwise.
         */
        virtual bool PostTransfer(ApplicationEngine& engine, const io::UInt160& from, const io::UInt160& to, int64_t amount, const io::ByteVector& tokenId, std::shared_ptr<vm::StackItem> data, bool callOnPayment);
    };
}
