...
namespace neo::smartcontract
{
    ...
    public:
         ...
         */
        static std::shared_ptr<vm::StackItem> Deserialize(const nlohmann::json& json, int64_t maxSize = 2048, int64_t maxItems = 2048);
    ...
    private:
         ...
         * @return The deserialized StackItem.
         */
        static std::shared_ptr<vm::StackItem> DeserializeStackItem(const nlohmann::json& json, 
