...
namespace neo::network::p2p
{
    ...
    public:
         ...
         * @param callback The callback.
         */
        void SetGetBlocksMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::GetBlocksPayload&)> callback);

        /**
         * @brief Sets the getblockbyindex message received callback.
         * @param callback The callback.
         */
        void SetGetBlockByIndexMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::GetBlockByIndexPayload&)> callback);

        /**
         * @brief Sets the getheaders message received callback.
         * @param callback The callback.
         */
        void SetGetHeadersMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::GetBlocksPayload&)> callback);
         ...
         * @param callback The callback.
         */
        void SetFilterAddMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::FilterAddPayload&)> callback);

        /**
         * @brief Sets the filterclear message received callback.
         * @param callback The callback.
         */
        void SetFilterClearMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::FilterClearPayload&)> callback);

        /**
         * @brief Sets the filterload message received callback.
         * @param callback The callback.
         */
        void SetFilterLoadMessageReceivedCallback(std::function<void(RemoteNode*, const payloads::FilterLoadPayload&)> callback);
