...
namespace neo::network::p2p::payloads
{
    ...
    public:
         ...
         * @param port The port.
         */
        NetworkAddressWithTime(uint32_t timestamp, uint64_t services, 
         ...
         */
        static NetworkAddressWithTime FromIPv4(uint32_t timestamp, uint64_t services,
         ...
         * @return The NetworkAddressWithTime.
         */
        static NetworkAddressWithTime FromIPv6(uint32_t timestamp, uint64_t services,
