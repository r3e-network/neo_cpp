...
namespace neo::wallets
{
    ...
    public:
         ...
         */
        virtual std::shared_ptr<Wallet> CreateWallet(const std::string& path, const std::string& password, const std::string& name) const = 0;
    ...
    public:
         ...
         * @return The new wallet.
         */
        std::shared_ptr<Wallet> CreateWallet(const std::string& path, const std::string& password, const std::string& name) const;
