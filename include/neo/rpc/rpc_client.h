...
class IHttpClient
{
   public:
     ...
     */
    virtual std::string Post(const std::string& url, const std::string& content,
     ...
     */
    virtual std::future<std::string> PostAsync(const std::string& url, const std::string& content,
                                               const std::map<std::string, std::string>& headers = {}) = 0;
};
...
class RpcClient
{
   public:
     ...
     * @param http_client Optional HTTP client implementation.
     */
    RpcClient(const std::string& base_url, const std::string& username, const std::string& password,
     ...
     */
    nlohmann::json InvokeFunction(const std::string& script_hash, const std::string& operation,
     ...
     */
    std::future<nlohmann::json> InvokeFunctionAsync(const std::string& script_hash, const std::string& operation,
                                                    const std::vector<nlohmann::json>& params = {});
