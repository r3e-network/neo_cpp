...
namespace neo::rpc
{
    ...
    public:
         ...
         */
        RpcResponse(const std::string& jsonrpc, const nlohmann::json& result, const nlohmann::json& error, const nlohmann::json& id);
         ...
         */
        static RpcResponse CreateErrorResponse(const nlohmann::json& id, int code, const std::string& message, const nlohmann::json& data = nullptr);
