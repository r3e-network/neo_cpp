...
namespace neo::extensions
{
    ...
    public:
         ...
         */
        static SecureString GenerateSecureRandom(size_t length, const std::string& charset = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789");
         ...
         */
        static bool ValidatePasswordStrength(const SecureString& password, 
                                            size_t minLength = 8,
