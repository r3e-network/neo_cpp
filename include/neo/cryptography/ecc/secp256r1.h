...
namespace neo::cryptography::ecc { class KeyPair; class ECPoint; }
...
namespace neo::cryptography::ecc
{
    ...
    public:
         ...
         */
        static std::string ToNEP2(const io::ByteVector& privateKey, const std::string& passphrase, int scryptN = 16384, int scryptR = 8, int scryptP = 8);
         ...
         */
        static io::ByteVector FromNEP2(const std::string& nep2, const std::string& passphrase, int scryptN, int scryptR, int scryptP);
    };
} 