...
namespace neo::ledger
{
    ...
    void TransactionAttribute::Serialize(io::BinaryWriter& writer) const
    {
        ...
        else if (usage_ == Usage::OracleResponse || usage_ == Usage::NotValidBefore ||
                 usage_ == Usage::Conflicts || usage_ == Usage::NotaryAssisted)
        {
        ...
        else if (usage_ == Usage::Description ||
                 (static_cast<uint8_t>(usage_) >= static_cast<uint8_t>(Usage::Remark) &&
