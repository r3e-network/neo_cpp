...
namespace neo::network::p2p
{
    ...
    public:
        void Start(const ChannelsConfig&) { LOG_INFO("LocalNode stub Start()"); }
        void Stop() { LOG_INFO("LocalNode stub Stop()"); }
    };
...
// PayloadFactory stub
std::shared_ptr<IPayload> PayloadFactory::DeserializePayload(
    MessageCommand command, io::BinaryReader& reader)
{
