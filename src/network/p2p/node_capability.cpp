...
namespace neo::network::p2p
{
    ...
    NodeCapability::NodeCapability()
        : type_(NodeCapabilityType::TcpServer)
    {
    }
    ...
    UnknownCapability::UnknownCapability()
        : NodeCapability(NodeCapabilityType::Unknown), rawType_(0)
    {
    }
    
    UnknownCapability::UnknownCapability(uint8_t type)
        : NodeCapability(NodeCapabilityType::Unknown), rawType_(type)
    {
    }
    ...
    ServerCapability::ServerCapability()
        : NodeCapability(NodeCapabilityType::TcpServer), port_(0)
    {
    }
    
    ServerCapability::ServerCapability(NodeCapabilityType type, uint16_t port)
        : NodeCapability(type), port_(port)
    {
    }
    ...
    FullNodeCapability::FullNodeCapability()
        : NodeCapability(NodeCapabilityType::FullNode), startHeight_(0)
    {
    }
