...
Message::Message() 
    : flags_(MessageFlags::None), 
      command_(MessageCommand::Version),
      payload_(nullptr)
{
}
...
{ 
    return (flags_ & MessageFlags::Compressed) != MessageFlags::None;
}
...
void Message::Serialize(io::BinaryWriter& writer) const
{
    ...
    std::memcpy(commandBytes.data(), commandStr.c_str(), 
                std::min(commandStr.length(), size_t(12)));
...
io::ByteVector Message::ToArray(bool enableCompression) const
{
    ...
    return io::ByteVector(io::ByteSpan(
...
std::string Message::GetCommandString(MessageCommand command)
{
    switch (command)
    {
        ...
        case MessageCommand::NotFound: return "notfound";
        case MessageCommand::FilterLoad: return "filterload";
        case MessageCommand::FilterAdd: return "filteradd";
        case MessageCommand::FilterClear: return "filterclear";
        case MessageCommand::MerkleBlock: return "merkleblock";
        case MessageCommand::Reject: return "reject";
        case MessageCommand::Alert: return "alert";
        case MessageCommand::Extensible: return "extensible";
