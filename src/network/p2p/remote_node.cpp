...
namespace neo::network::p2p
{
    ...
    bool RemoteNode::SendPing()
    {
        ...
        auto payload = std::make_shared<payloads::PingPayload>(payloads::PingPayload::Create(localNode_->GetLastBlockIndex()));
    ...
    void RemoteNode::OnMessageReceived(const Message& message)
    {
        ...
        switch (message.GetCommand())
        {
            ...
            default:
                ...
                LOG_DEBUG("RemoteNode received unhandled message type: {}", 
