...
namespace neo::network::p2p
{
    ...
    void NetworkSynchronizer::SetTransactionReceivedCallback(std::function<void(const std::shared_ptr<ledger::Transaction>&)> callback)
    {
    ...
    void NetworkSynchronizer::OnTransactionMessageReceived(RemoteNode* remoteNode, const std::shared_ptr<ledger::Transaction>& transaction)
    {
    ...
    void NetworkSynchronizer::ProcessPendingBlocks()
    {
        ...
        std::sort(blocksToProcess.begin(), blocksToProcess.end(), [](const auto& a, const auto& b) {
