...
namespace neo::network::p2p
{
    ...
    {
        LOG_DEBUG("HandleMessage stub: peer={} command={}", 
                 peer_id.ToString(), 
                 static_cast<uint8_t>(message.GetCommand()));
    }
    ...
    void ProtocolHandler::RelayInventory(payloads::InventoryType type, const io::UInt256& hash, const io::UInt256& source_peer)
    {
        LOG_DEBUG("RelayInventory stub: type={} hash={}", 
                 static_cast<uint8_t>(type), hash.ToString());
    }
