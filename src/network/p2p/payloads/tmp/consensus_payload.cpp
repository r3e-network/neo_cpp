...
{
ConsensusPayload::ConsensusPayload() : version_(0), blockIndex_(0), validatorIndex_(0) {}
...
ConsensusPayload::ConsensusPayload(uint32_t version, const io::UInt256& prevHash, uint32_t blockIndex,
    ...
    : version_(version), prevHash_(prevHash), blockIndex_(blockIndex), validatorIndex_(validatorIndex), data_(data)
{
}
