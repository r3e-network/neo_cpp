...
namespace neo::rpc
{
    ...
    RpcResponse::RpcResponse(const std::string& jsonrpc, const nlohmann::json& result, const nlohmann::json& error, const nlohmann::json& id)
    ...
    RpcResponse RpcResponse::CreateErrorResponse(const nlohmann::json& id, int code, const std::string& message, const nlohmann::json& data)
    {
        nlohmann::json error;
        error["code"] = code;
