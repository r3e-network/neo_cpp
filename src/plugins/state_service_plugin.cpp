...
namespace neo::plugins
{
    StateServicePlugin::StateServicePlugin()
        : PluginBase("StateService", "Provides state service functionality", "1.0", "Neo C++ Team"),
          statePath_("StateRoot")
    {
    }
    ...
    io::UInt256 StateServicePlugin::CalculateStateRoot(uint32_t index, const std::vector<std::pair<persistence::StorageKey, persistence::StorageItem>>& changes)
    {
        // Create hashes
