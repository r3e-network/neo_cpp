...
namespace neo::console_service
{
    ...
    CommandToken::CommandToken(CommandTokenType type, int offset)
    ...
    std::vector<std::string> CommandToken::ToArguments(const std::vector<std::shared_ptr<CommandToken>>& tokens, bool remove_escape)
    {
    ...
    CommandSpaceToken::CommandSpaceToken(int offset)
        : CommandToken(CommandTokenType::Space, offset)
    {
    }
    ...
    std::shared_ptr<CommandStringToken> CommandStringToken::Parse(const std::string& command_line, int& index, std::shared_ptr<CommandQuoteToken> quote)
    {
        int start = index;
        std::ostringstream oss;
