...
namespace neo::wallets
{
    ...
    std::vector<uint8_t> Helper::CreateMultiSigScript(int m, const std::vector<neo::cryptography::ecc::ECPoint>& public_keys)
    {
    ...
    std::vector<uint8_t> Helper::Sign(const uint8_t* message, size_t message_size, const uint8_t* private_key, size_t private_key_size)
    {
    ...
    bool Helper::VerifySignature(const uint8_t* message, size_t message_size,
    ...
    bool Helper::VerifySignature(io::ByteSpan message, io::ByteSpan signature, const neo::cryptography::ecc::ECPoint& public_key)
    {
