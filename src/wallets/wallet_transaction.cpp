    ...
    void WalletTransaction::SerializeJson(io::JsonWriter& writer) const
    {
        ...
        try {
            ...
            if (confirmed_) {
                ...
                switch (vm_state_) {
                    case vm::VMState::Halt: vm_state_str = "HALT"; break;
                    case vm::VMState::Fault: vm_state_str = "FAULT"; break;
                    case vm::VMState::Break: vm_state_str = "BREAK"; break;
                    default: vm_state_str = "NONE"; break;
                }
