...
namespace neo::wallets
{
    TransferOutput::TransferOutput()
        : asset_id_(io::UInt160::Zero()), script_hash_(io::UInt160::Zero()), amount_(0)
    {
    }

    TransferOutput::TransferOutput(const io::UInt160& asset_id, const io::UInt160& script_hash, int64_t amount, const std::string& data)
