...
BigDecimal::BigDecimal(const BigInteger& value, uint8_t decimals)
...
std::pair<BigDecimal::BigInteger, BigDecimal::BigInteger> 
BigDecimal::normalize(const BigDecimal& left, const BigDecimal& right) {
