...
{
NameService::NameService() : NativeContract(NAME, ID) {}
...
void NameService::Initialize()
{
    RegisterMethod("getPrice", CallFlags::ReadStates,
                   std::bind(&NameService::OnGetPrice, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("setPrice", CallFlags::States,
                   std::bind(&NameService::OnSetPrice, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("isAvailable", CallFlags::ReadStates,
                   std::bind(&NameService::OnIsAvailable, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("register", CallFlags::States | CallFlags::AllowCall | CallFlags::AllowNotify,
                   std::bind(&NameService::OnRegister, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("renew", CallFlags::States | CallFlags::AllowCall | CallFlags::AllowNotify,
                   std::bind(&NameService::OnRenew, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("transfer", CallFlags::States | CallFlags::AllowNotify,
                   std::bind(&NameService::OnTransfer, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("delete", CallFlags::States | CallFlags::AllowNotify,
                   std::bind(&NameService::OnDelete, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("resolve", CallFlags::ReadStates,
                   std::bind(&NameService::OnResolve, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("getOwner", CallFlags::ReadStates,
                   std::bind(&NameService::OnGetOwner, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("getExpiration", CallFlags::ReadStates,
                   std::bind(&NameService::OnGetExpiration, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("getRecord", CallFlags::ReadStates,
                   std::bind(&NameService::OnGetRecord, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("setRecord", CallFlags::States | CallFlags::AllowNotify,
                   std::bind(&NameService::OnSetRecord, this, std::placeholders::_1, std::placeholders::_2));
    RegisterMethod("deleteRecord", CallFlags::States | CallFlags::AllowNotify,
                   std::bind(&NameService::OnDeleteRecord, this, std::placeholders::_1, std::placeholders::_2));
}
...
std::shared_ptr<vm::StackItem> NameService::OnGetPrice(ApplicationEngine& engine,
