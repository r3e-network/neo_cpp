/**
 * @file fungible_token.cpp
 * @brief Fungible Token
 * @author Neo C++ Team
 * @date 2025
...
bool FungibleToken::PostTransfer(ApplicationEngine& engine, const io::UInt160& from, const io::UInt160& to,
                                 int64_t amount, std::shared_ptr<vm::StackItem> data, bool callOnPayment)
{
