...
{
    std::shared_ptr<vm::StackItem> NameService::OnRegister(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.size() < 2)
    ...
    std::shared_ptr<vm::StackItem> NameService::OnRenew(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.empty())
            throw std::runtime_error("Invalid arguments");
        ...
        // Renew name
        auto newExpiration = std::max(expiration, static_cast<uint64_t>(engine.GetSnapshot()->GetCurrentBlockIndex())) + REGISTRATION_DURATION;
        std::ostringstream stream;
        io::BinaryWriter writer(stream);
        writer.Write(owner);
    ...
    std::shared_ptr<vm::StackItem> NameService::OnTransfer(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.size() < 2)
            throw std::runtime_error("Invalid arguments");
    ...
    std::shared_ptr<vm::StackItem> NameService::OnDelete(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.empty())
            throw std::runtime_error("Invalid arguments");
    ...
    std::shared_ptr<vm::StackItem> NameService::OnResolve(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.empty())
            throw std::runtime_error("Invalid arguments");
    ...
    std::shared_ptr<vm::StackItem> NameService::OnGetOwner(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.empty())
            throw std::runtime_error("Invalid arguments");
    ...
    std::shared_ptr<vm::StackItem> NameService::OnGetExpiration(ApplicationEngine& engine, const std::vector<std::shared_ptr<vm::StackItem>>& args)
    {
        if (args.empty())
            throw std::runtime_error("Invalid arguments");
