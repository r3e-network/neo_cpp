...
namespace neo::smartcontract::native
{
    ...
    OracleRequest::OracleRequest(const io::UInt256& originalTxid, int64_t gasForResponse, const std::string& url, const std::string& filter,
                               const io::UInt160& callbackContract, const std::string& callbackMethod, const io::ByteVector& userData)
