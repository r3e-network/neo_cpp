...
namespace neo::smartcontract::native
{
    ...
    bool CryptoLib::VerifySecp256k1Signature(const io::ByteVector& message, const io::ByteVector& signature, const cryptography::ecc::ECPoint& publicKey)
    {
        try {
    ...
    std::pair<std::optional<io::ByteVector>, std::optional<io::ByteVector>> CryptoLib::ParseSecp256k1Signature(const io::ByteVector& signature)
    {
        try {
            // Parse DER-encoded signature for secp256k1
    ...
    bool CryptoLib::VerifySecp256k1ECDSA(const io::UInt256& messageHash, const io::ByteVector& r, const io::ByteVector& s, const cryptography::ecc::ECPoint& publicKey)
    {
        try {
