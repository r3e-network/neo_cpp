...
void ProtocolSettings::SetMaxValidUntilBlockIncrement(uint32_t maxValidUntilBlockIncrement)
{
    maxValidUntilBlockIncrement_ = maxValidUntilBlockIncrement;
}
void ProtocolSettings::SetMaxTransactionsPerBlock(uint32_t maxTransactionsPerBlock)
{
    maxTransactionsPerBlock_ = maxTransactionsPerBlock;
}
void ProtocolSettings::SetMemoryPoolMaxTransactions(int memoryPoolMaxTransactions)
{
