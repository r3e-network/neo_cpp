...
namespace neo::vm
{
    ...
    BooleanItem::BooleanItem(bool value)
        : value_(value)
    {
    }
    ...
    IntegerItem::IntegerItem(int64_t value)
        : value_(value)
    {
    }
    ...
    ByteStringItem::ByteStringItem(const io::ByteVector& value)
        : value_(value)
    {
    }

    ByteStringItem::ByteStringItem(const io::ByteSpan& value)
        : value_(value)
    {
    }
    ...
    BufferItem::BufferItem(const io::ByteVector& value)
        : value_(value)
    {
    }

    BufferItem::BufferItem(const io::ByteSpan& value)
        : value_(value)
    {
    }
