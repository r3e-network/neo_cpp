...
namespace neo::cryptography::bls12_381
{
        ...
        public:
            ...
            FieldElement operator+(const FieldElement& other) const
            {
                ...
                static const std::array<uint8_t, SIZE> MODULUS = {
                    0xab, 0xaa, 0xff, 0xff, 0xff, 0xfe, 0xb9, 0xff, 0xff, 0x53, 0xb1, 0xfe, 
    ...
    GTPoint Pairing(const G1Point& p, const G2Point& q)
    {
        ...
        std::copy(result_bytes.AsSpan().Data(), 
                 result_bytes.AsSpan().Data() + std::min(GTPoint::Size, result_bytes.Size()), 
                 accumulator.begin());
    ...
    bool InvertFp(const uint8_t* a, uint8_t* result) {
        ...
        std::array<uint64_t, 6> p_minus_2 = {
