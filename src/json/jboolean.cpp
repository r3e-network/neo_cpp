...
JTokenType JBoolean::GetType() const
{
    return JTokenType::Boolean;
}

bool JBoolean::AsBoolean() const
{
    return value_;
}

bool JBoolean::GetBoolean() const
{
    return value_;
}
...
std::shared_ptr<JToken> JBoolean::Clone() const
{
    return std::make_shared<JBoolean>(value_);
}

bool JBoolean::Equals(const JToken& other) const
{
    if (other.GetType() != JTokenType::Boolean)
        return false;
