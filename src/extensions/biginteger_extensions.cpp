/**
 * @file biginteger_extensions.cpp
...
{
// Constants
const BigIntegerExtensions::BigInteger BigIntegerExtensions::Zero =
    BigIntegerExtensions::BigInteger(static_cast<int64_t>(0));
const BigIntegerExtensions::BigInteger BigIntegerExtensions::One =
    BigIntegerExtensions::BigInteger(static_cast<int64_t>(1));
const BigIntegerExtensions::BigInteger BigIntegerExtensions::MinusOne =
    BigIntegerExtensions::BigInteger(static_cast<int64_t>(-1));
...
BigIntegerExtensions::BigInteger BigIntegerExtensions::FromString(const std::string& value)
{
    ...
    try
    {
        ...
        if (number_part.length() <= 18)
        {  // int64_t max is 19 digits, be conservative
            try
            {
...
BigIntegerExtensions::BigInteger BigIntegerExtensions::Power(const BigInteger& baseValue, uint32_t exponent)
{
    ...
    {
        int64_t base =
            baseValue.isNegative ? -static_cast<int64_t>(baseValue.words[0]) : static_cast<int64_t>(baseValue.words[0]);
        int64_t result = 1;
...
BigIntegerExtensions::BigInteger BigIntegerExtensions::GreatestCommonDivisor(const BigInteger& left,
