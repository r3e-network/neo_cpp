...
class NeoTestnetNode
{
  ...
  public:
    NeoTestnetNode()
        : block_height_(0), network_magic_(894710606)  // Neo Testnet magic number
          ,
          node_version_("3.6.0"), start_time_(std::chrono::steady_clock::now())
    {
  ...
  private:
    ...
    void ProcessBlock()
    {
        ...
        std::cout << "📦 Processing block #" << block_height_ << " - Hash: " << blockHash.ToString().substr(0, 16)
                  << "...\n";
